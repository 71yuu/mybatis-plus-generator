...
public class MyBatisPlusGenerator {
	 ...
	 * JDBC 连接地址
	 */
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/mp_generator?characterEncoding=UTF-8&useUnicode=true&useSSL=false&tinyInt1isBit=false";
	 ...
	 * 包配置 - 父级目录
	 */
	private static final String PACKAGE_PARENT = "com.yuu.boot.mybatis.plus.generator";

	/**
	 * 包配置 - 模块目录 <br>
	 * 注意：如果表前缀与模块命相同，生成时会删除前缀，比如：core_admin 最终构建为 Admin, AdminController ...
	 */
	private static final String PACKAGE_MODULE_NAME = "mp";
